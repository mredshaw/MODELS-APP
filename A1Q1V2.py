...
#############################################################################################################################################################    
## Adding a cost penalty to transhipped oil to encourage direct shipping and limit transshipment
...
# The penalty is applied to the y variables which represent transshipment quantities
...
# Print the number of decision variables and the total transportation cost
print("Number of Decision Variables: ", model.numVars)
print("Total Penalized Transportation cost: ", model.objVal)
...
# Print the results
print("Total Penalized Transshipped Amount: ", total_transshipped)
print("Total Penalized Transported Amount: ", total_transported)
print("Proportion of Penalized Canola Oil Transshipped: ", proportion_transshipped)



#############################################################################################################################################################
#Adding a ratio contraint to transhipments
...
# Add ratio constraint to the model
model.addConstr(
...
print("Updated Total Transportation Cost with Ratio Constraint: ", model.objVal)
...
# Recalculate the total transshipped amount
total_transshipped_updated = sum(y[p, t].x for p, t in y)

# Recalculate the total transported amount (including both direct and transshipped shipments)
total_transported_updated = sum(x[p, r].x for p, r in x) + total_transshipped_updated

# Recalculate the proportion of canola oil that is transshipped
proportion_transshipped_updated = total_transshipped_updated / total_transported_updated if total_transported_updated > 0 else 0

# Print the updated results
print("Updated Total Transshipped Amount: ", total_transshipped_updated)
print("Updated Total Transported Amount: ", total_transported_updated)
print("Updated Proportion of Canola Oil Transshipped: ", proportion_transshipped_updated)